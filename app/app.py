...
# добавление объявления с помощью POST запроса
...
# Добавление тега в существующее объявление с помощью POST запроса
...
# Добавление комментария в существующее объявление с помощью POST запроса
...
# Получение объявления с помощью GET запроса
...
# Получение всех объявлений с помощью GET запроса
